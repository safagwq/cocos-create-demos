module.exports = {
    ...
    'rules' : {
        ...
        'comma-spacing' : [2 , { 'before' : true , 'after' : true }] , //逗号后面的空格
        'key-spacing' : [1 , { 'beforeColon' : true , 'afterColon' : true }] , //对象字面量中冒号的前后空格
        ...
        'max-statements' : [0 , 20] , //函数内最多有几个声明
        ...
        'semi-spacing' : [0 , { 'before' : true , 'after' : true }] , //分号前后空格
        'sort-vars' : 0 , //变量声明时排序
